...
def label_point(x, y, text, offset=(0.1,0.1), color='black'):
    """
    Labels a point (x, y) on a matplotlib plot with given text.
    - offset: (dx, dy) controls label position
    - color: text color
    """
    plt.text(x + offset[0], y + offset[1], text,
